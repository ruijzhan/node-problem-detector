...
build-binaries: ./bin/node-problem-detector ./bin/log-counter ./bin/check-fd ./bin/check-zombies

build-container: build-binaries Dockerfile
	docker build -t $(IMAGE) .

build-tar: ./bin/node-problem-detector ./bin/log-counter ./bin/check-fd ./bin/check-zombies
